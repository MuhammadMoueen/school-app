...
class Quiz(models.Model):
    ...
    total_marks = models.DecimalField(max_digits=5, decimal_places=2, null=True, blank=False)
    passing_marks = models.DecimalField(max_digits=5, decimal_places=2, null=True, blank=False)
