...
class AssignmentSubmission(models.Model):
    ...
    teacher_marks_5 = models.DecimalField(max_digits=4, decimal_places=2, null=True, blank=True)
...
class Quiz(models.Model):
    ...
    auto_submit_on_timeout = models.BooleanField(default=False)
    ...
    paper_file = models.FileField(upload_to='quiz_papers/%Y/%m/', blank=True, null=True, help_text='Full question paper (PDF, Image, Word, Excel)')
...
class Question(models.Model):
    ...
    question_file = models.FileField(upload_to='questions/%Y/%m/', blank=True, null=True, help_text='Upload question file (PDF, Image, Word, etc.)')
...
class Transcript(models.Model):
    ...
    attendance_marks = models.DecimalField(max_digits=4, decimal_places=2, default=0)
    quiz_marks = models.DecimalField(max_digits=4, decimal_places=2, default=0)
    assignment_marks = models.DecimalField(max_digits=4, decimal_places=2, default=0)
    behavior_marks = models.DecimalField(max_digits=4, decimal_places=2, default=0)
    sessional_marks = models.DecimalField(max_digits=5, decimal_places=2, default=0)
    sessional_auto_enabled = models.BooleanField(default=True)
    sessional_override_marks = models.DecimalField(max_digits=5, decimal_places=2, null=True, blank=True)
    remarks = models.TextField(blank=True)
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
